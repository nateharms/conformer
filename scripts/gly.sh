...
stdbuf -o0 -e0 python -u ~/Code/conformer/scripts/optimizing.py 2 > /gss_gpfs_scratch/harms.n/conformers/new_ga_results/log_files/gly.$SLURM_ARRAY_TASK_ID.combined.log 2>&1