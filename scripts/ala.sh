...
stdbuf -o0 -e0 python -u ~/Code/conformer/scripts/optimizing.py 1 > /gss_gpfs_scratch/harms.n/conformers/es_results/log_files/ala.$SLURM_ARRAY_TASK_ID.combined.log 2>&1
