...
if not os.path.exists("/home/harms.n/Code/ga_conformer/results/{0}_{1}_es.xyz".format(name, job_number)):
    ...
    label = "{0}_{1}_es".format(name, job_number)#str(name) + "_" + str(job_number)
    ...
    print "~/Code/ga_conformer/results/{0}_{1}_es.xyz".format(name, job_number)
print "Job complete!!!"
